...
int sub_386C(unsigned char arg_0) {
    ...
    var_C = g_array_at_10E[(int)(signed char)arg_0];

    if (var_C == 0 || var_C >= 3) {
         return 0;
    } else {

        var_A = (int)g_array_at_E9D6[(int)(signed char)arg_0];
        ...
        if ((sub_5876(var_6 + 2, var_8 + 6) & 0x08) == 0) {
            ...
            if (g_array_at_10E[(int)(signed char)arg_0] == 4) {
                var_8++;
            }

            g_array_at_10E[(int)(signed char)arg_0] = 0;
            ...
            sub_498C((int)(signed char)arg_0);
            return 1;
        }
    }
}
